...
def create_bds_v2_for_navis():
    """NABIS 비교용 BDS v2.0 생성"""
    
    print("🚀 BDS v2.0 (NABIS 비교용) 생성 시작")
    print("="*60)
    ...
    # 2019년 기준 최종 BDS v2.0 점수 (NABIS 비교용)
    bds_v2_2019 = {}
    for region in regions:
    ...
    # 결과 저장
    output_data = {
        'methodology': 'BDS v2.0 for NABIS Comparison',
        'description': 'NABIS 비교를 위한 3지표 기반 BDS (서비스업 생산지수 제외)',
...
def create_navis_bds_comparison_data():
    """NABIS vs BDS v2.0 비교 데이터 생성"""
    
    print(f"\n🔗 NABIS vs BDS v2.0 비교 데이터 생성")
    print("="*60)
    
    # NABIS 2019년 데이터 (기존 데이터 활용)
    navis_2019 = {
    ...
    comparison_data = {
        ...
        'methodology': 'NABIS vs BDS v2.0 Correlation Analysis',
...
def main():
    ...
    print("🚀 NABIS 비교용 BDS v2.0 생성 프로세스 시작")
    print("="*80)
    ...
    try:
        ...
        print(f"\n🔄 다음 단계:")
        print(f"   1. 대시보드에 NABIS vs BDS v2.0 비교 차트 추가")
