...
- **경험적 가중치 설정**: 지역발전 관련 주요 지표의 일반적 중요도를 고려한 가중치 적용 (학술적 검증 필요)
...
- **ECOS 데이터**: 1997-2025년 (29년간 수집 완료)
- **지역 수**: 17개 행정구역
- **총 데이터 포인트**: 413건 (연도별 × 지역별)
- **업데이트**: 2025년 9월 29일 전체 시계열 ECOS 데이터 통합 완료
